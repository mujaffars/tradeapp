...
window.jsBezier={
    ...
    var a={
        ...
        c=c||a.parentNode;
        for(var d=c.querySelectorAll(b),e=0;e<d.length;e++)if(d[e]===a)return!0;return!1
        },c=function(a){
    ...
    null!=d&&E(a,function(){
        var a=c(this);
        if(h(a,b,d),null!=d.__tauid)if(a.removeEventListener)a.removeEventListener(b,d,!1);
...
this.Mottle=function(b){
    ...
    this.remove=function(a){
        return E(a,function(){
            var a=c(this);
            if(a.__ta)for(var b in a.__ta)for(var d in a.__ta[b])D(a,b,a.__ta[b][d]);a.parentNode&&a.parentNode.removeChild(a)
            }),this
        },this.on=function(){
        ...
        if(document.createEvent){
            ...
            }else document.createEventObject&&(b=document.createEventObject(),b.eventType=b.eventName=g,b.screenX=i[0],b.screenY=i[1],b.clientX=j[0],b.clientY=j[1],l(b),k.fireEvent("on"+g,b))
            }),this
}
    ...
    if("Microsoft Internet Explorer"==navigator.appName){
        ...
        return a
    }(),d=c>-1&&9>c,e=function(a){
    if(d)return[a.clientX+document.documentElement.scrollLeft,a.clientY+document.documentElement.scrollTop];
    var b=g(a),c=f(b,0);
...
},i="katavorio-drag-scope",j=["stop","start","drag","drop","over","out"],k=function(){},l=function(){
    return!0
    },m=function(a,b,c){
    ...
    this.params=b||{},this.el=a,this.params.addClass(this.el,this._class);
    var e=!0;
    ...
    var h=[0,0],i=null,j=!1,k=this.params.consumeStartEvent!==!1,m=this.el,o=this.params.clone;
    ...
    var q=l,t="",u=this.params.filterExclude!==!1,v=this.setFilter=function(a,d){
        a&&(t=a,u=d!==!1,q=function(d){
            var e=d.srcElement||d.target,f=b(e,a,c);
            return u?!f:f
            })
        };
    ...
    this.downListener=function(b){
        ...
        if(c&&this.isEnabled()&&this.canDrag()){
            ...
            if(d){
                if(o){
                    m=this.el.cloneNode(!0),m.setAttribute("id",null),m.style.position="absolute";
                    var i=a(this.el);
                    m.style.left=i.left+"px",m.style.top=i.top+"px",document.body.appendChild(m)
                    }else m=this.el;
                k&&p(b),h=e(b),this.params.bind(document,"mousemove",this.moveListener),this.params.bind(document,"mouseup",this.upListener),g.markSelection(this),this.params.addClass(document.body,f.noSelect)
                }else this.params.consumeFilteredEvents&&p(b)
                }
            }.bind(this),this.moveListener=function(a){
    if(h){
        j||(this.params.events.start({
            el:this.el,
            pos:i,
            e:a,
            drag:this
        }),this.mark(),j=!0),y.length=0;
        var b=e(a),c=b[0]-h[0],d=b[1]-h[1],f=this.params.ignoreZoom?1:g.getZoom();
        c/=f,d/=f,this.moveBy(c,d,a),g.updateSelection(c,d,this)
        }
    }.bind(this),this.upListener=function(a){
    h=null,j=!1,this.params.unbind(document,"mousemove",this.moveListener),this.params.unbind(document,"mouseup",this.upListener),this.params.removeClass(document.body,f.noSelect),this.unmark(a),g.unmarkSelection(this,a),this.stop(a),g.notifySelectionDragStop(this,a),o&&(m&&m.parentNode&&m.parentNode.removeChild(m),m=null)
    }.bind(this),this.getFilter=function(){
    return t
    ...
    if(i=this.params.getPosition(m),this.size=this.params.getSize(m),x=g.getMatchingDroppables(this),n(x,!0,!1,this),this.params.addClass(m,this.params.dragClass||f.drag),this.params.constrain||this.params.containment){
    ...
    n(x,!1,!0,this),x.length=0;
    for(var b=0;b<y.length;b++)y[b].drop(this,a)
        },this.moveBy=function(a,b,c){
    y.length=0;
    var d=this.constrain(this.toGrid([i[0]+a,i[1]+b]),m),e={
        x:d[0],
        y:d[1],
        w:this.size[0],
        h:this.size[1]
...
this.Katavorio=function(a){
    ...
    var d=1,e=function(a,b){
        ...
        for(var d=0,e=0;e<b.scopes.length;e++)if(c[b.scopes[e]]){
        ...
        for(var b=[],c={},d=0;d<a.scopes.length;d++){
            ...
            if(e)for(var f=0;f<e.length;f++)e[f].canDrop(a)&&!c[e[f].el._katavorio]&&e[f].el!==a.el&&(c[e[f].el._katavorio]=!0,b.push(e[f]))
                }
                return b
        },function(b){
        b=b||{};
    ...
    for(var d in a)c[d]=a[d];for(var d in b)c[d]=b[d];for(var d=0;d<j.length;d++)c.events[j[d]]=b[j[d]]||k;
        return c.katavorio=this,c
        }.bind(this)),l={},n=a.css||{},p=a.scope||i;
for(var r in h)l[r]=h[r];for(var r in n)l[r]=n[r];var s=a.inputFilterSelector||q;
this.getInputFilterSelector=function(){
    ...
    return o(b,function(b){
        if(b=w(b),null!=b){
            var f=g(c);
            b._katavorioDrag=new t(b,f,l,p),e(b._katavorioDrag,this._dragsByScope),d.push(b._katavorioDrag),a.addClass(b,l.draggable)
            }
        }.bind(this)),d
},this.droppable=function(b,c){
    var d=[];
    return o(b,function(b){
        b=w(b),null!=b&&(b._katavorioDrop=new u(b,g(c),l,p),e(b._katavorioDrop,this._dropsByScope),d.push(b._katavorioDrop),a.addClass(b,l.droppable))
        }.bind(this)),d
    },this.select=function(d){
    return o(d,function(){
        var d=w(this);
        d&&d._katavorioDrag&&(c[d._katavorio]||(b.push(d._katavorioDrag),c[d._katavorio]=[d,b.length-1],a.addClass(d,l.selected)))
        }),this
...
o(["set","add","remove","toggle"],function(a){
    ...
    var a=function(a){
        ...
        clone:function(b){
            ...
            if(a(b)){
                ...
                for(var k in b)j[k]=this.clone(b[k]);return j
                }
                return b
            },
        merge:function(b,e,g){
            ...
            var k=this.clone(b);
            for(i in e)if(null==k[i])k[i]=e[i];
        ...
        var e=function(a){
            ...
            if(null!=b){
                ...
                if(a(b)){
                    ...
                    for(var j in b)i[j]=g(b[j]);return i
                    }
                    return b
                }
            };
...
findWithFunction:function(a,b){
    if(a)for(var c=0;c<a.length;c++)if(b(a[c]))return c;return-1
    },
...
extend:function(b,c){
    var d;
    for(c=a(c)?c:[c],d=0;d<c.length;d++)for(var e in c[d].prototype)c[d].prototype.hasOwnProperty(e)&&(b.prototype[e]=c[d].prototype[e]);var f=function(a,b){
        return function(){
...
var m=function(a){
    ...
    var d=o(a),e=d.split(/\s+/),f=function(a,b){
        for(var c=0;c<b.length;c++)if(a)-1==jsPlumbUtil.indexOf(e,b[c])&&e.push(b[c]);
            else{
...
f(!0,b),f(!1,c),n(a,e.join(" "))
    ...
    if(null!=a)if("string"==typeof a)b(jsPlumb.getDOMElement(a));
        else if(null!=a.length)for(var c=0;c<a.length;c++)b(jsPlumb.getDOMElement(a[c]));else b(a)
        };
...
setAbsolutePosition:function(b,c,d,e){
    ...
    if(b.getDefaultType){
        for(var e=b.getTypeDescriptor(),f=a.merge({},b.getDefaultType()),g=0,h=b._jsPlumb.types.length;h>g;g++)f=a.merge(f,b._jsPlumb.instance.getType(b._jsPlumb.types[g],e),["cssClass"]);
    ...
    if(this._jsPlumb={
        ...
        return f
        },b.events)for(var g in b.events)c.bind(g,b.events[g]);this.clone=function(){
        var a={};
    ...
    this.setListenerComponent=function(a){
        for(var b=0;b<h.length;b++)h[b][3]=a
            }
        },j=function(a,b){
...
jsPlumbUtil.extend(i,jsPlumbUtil.EventGenerator,{
    ...
    addType:function(a,b,c){
        var d=g(a),e=!1;
        if(null!=d){
            for(var f=0,i=d.length;i>f;f++)this.hasType(d[f])||(this._jsPlumb.types.push(d[f]),e=!0);
            e&&h(this,b,c)
            }
        },
removeType:function(b,c){
    ...
    if(null!=d){
        for(var i=0,k=d.length;k>i;i++)e=f(d[i])||e;
        e&&h(this,null,c)
        }
    },
clearTypes:function(a){
    for(var b=this._jsPlumb.types.length,c=0;b>c;c++)j(this,0),this._jsPlumb.types.splice(0,1);
    h(this,{},a)
    },
...
var k="__label",l=function(a,b){
    ...
    if(a.label){
        ...
        this.setListenerComponent=function(a){
        if(this._jsPlumb)for(var b=0;b<this._jsPlumb.overlays.length;b++)this._jsPlumb.overlays[b].setListenerComponent(a)
            }
        };
...
for(var m in this.Defaults)j[m]=this.Defaults[m];var n;
this.setContainer=function(a){
    ...
    for(var b=function(a,b){
        ...
        },d=0;d<e.length;d++)c(e[d])
        },this.getContainer=function(){
    return n
    },this.bind=function(a,b){
    "ready"===a&&p?b():h.apply(f,[a,b])
    },f.importDefaults=function(a){
    for(var b in a)f.Defaults[b]=a[b];return a.Container&&f.setContainer(a.Container),f
...
var o=null,p=!1,q=[],s={},u={},v={},w={},x={},y={},z=!1,A=[],B=!1,C=null,D=this.Defaults.Scope,E=null,F=1,G=function(){
    ...
    if(!jsPlumbAdapter.headless&&!B){
        ...
        if(h)for(var j in h)tb({
            ...
            recalc:!1,
            timestamp:d
        });if(f.anchorManager.redraw(g,b,d,null,e),h)for(var k in h)f.anchorManager.redraw(h[k].id,b,d,h[k].offset,e,!0)
            }
        },J=function(b,c){
    var d,e,g,h=null;
    if(a.isArray(b)){
        h=[];
        for(var i=0,j=b.length;j>i;i++)d=f.getElementObject(b[i]),g=f.getDOMElement(d),e=f.getAttribute(g,"id"),h.push(c.apply(f,[g,e]))
            }else d=f.getDOMElement(b),e=f.getId(d),h=c.apply(f,[d,e]);
    return h
    },K=function(a){
    return u[a]
    },L=function(b,c,d,e){
    if(!jsPlumbAdapter.headless){
        ...
        if(g&&t.isDragSupported(b,f)&&!t.isAlreadyDraggable(b,f)){
            ...
            rb(e,b),h[k]=a.wrap(h[k],function(){
                return o=null!=m?jsPlumbAdapter.getOffset(m,f):n,f.setHoverSuspended(!0),f.select({
                    source:b
                }).addClass(f.elementDraggingClass+" "+f.sourceElementDraggingClass,!0),f.select({
                    target:b
                }).addClass(f.elementDraggingClass+" "+f.targetElementDraggingClass,!0),f.setConnectionBeingDragged(!0),h.canDrag?d.canDrag():void 0
                ...
                I(b,a),p=!1,f.removeClass(b,"jsPlumb_dragged"),f.setHoverSuspended(!1),f.select({
                    source:b
                }).removeClass(f.elementDraggingClass+" "+f.sourceElementDraggingClass,!0),f.select({
                    target:b
                }).removeClass(f.elementDraggingClass+" "+f.targetElementDraggingClass,!0),f.setConnectionBeingDragged(!1),f.dragManager.dragEnded(b)
                });
            var q=X(b);
            y[q]=!0;
            var r=y[q];
    ...
    for(var c=a.scope.split(/\s/),d=b.scope.split(/\s/),e=0;e<c.length;e++)for(var f=0;f<d.length;f++)if(d[f]==c[e])return!0;return!1
    },N=function(b,c){
    var d=t.extend({},b);
    if(c&&t.extend(d,c),d.source&&(d.source.endpoint?d.sourceEndpoint=d.source:d.source=f.getDOMElement(d.source)),d.target&&(d.target.endpoint?d.targetEndpoint=d.target:d.target=f.getDOMElement(d.target)),b.uuids&&(d.sourceEndpoint=K(b.uuids[0]),d.targetEndpoint=K(b.uuids[1])),d.sourceEndpoint&&d.sourceEndpoint.isFull())return a.log(f,"could not add connection; source endpoint is full"),void 0;
    if(d.targetEndpoint&&d.targetEndpoint.isFull())return a.log(f,"could not add connection; target endpoint is full"),void 0;
    ...
    var h=function(a,b){
        var c=t.extend({},a);
        for(var d in b)b[d]&&(c[d]=b[d]);return c
        },i=function(a,b,c){
        ...
        if(d[a]&&!d[a].endpoint&&!d[a+"Endpoint"]&&!d.newConnection){
            ...
            if(f){
                ...
                if(f.uniqueEndpoint&&(f.endpoint=g),g.isFull())return!1;
...
this.setConnectionBeingDragged=function(a){
    ...
    if(d&&d.length>0)try{
        for(var g=0,h=d.length;h>g;g++)e=e&&d[g](c)
            }catch(i){
...
var Y=[{
    ...
    if(b.constructor==t.Endpoint)e=b,e.addConnection(a);
    else if(f=X(b),g=this[h.epDefs][f],f===a[h.elId])e=null;
    else if(g){
        if(!g.enabled)return;
...
this.unregisterEndpoint=function(a){
    ...
    if(0!==arguments.length){
        ...
        if(g)(e||jsPlumbUtil.functionChain(!0,!1,[[g.endpoints[0],"isDetachAllowed",[g]],[g.endpoints[1],"isDetachAllowed",[g]],[g,"isDetachAllowed",[g]],[f,"checkCondition",["beforeDetach",g]]]))&&g.endpoints[0].detach(g,!1,!0,d);
            ...
            var h=t.extend({},c);
            if(h.uuids)K(h.uuids[0]).detachFrom(K(h.uuids[1]),d);
    ...
    var c=X(a),d=s[c];
    if(d&&d.length)for(var e=0,g=d.length;g>e;e++)d[e].detachAll(b.fireEvent!==!1);
    return f
...
for(var h in b.connections){
    ...
    var c,d,e;
    if("object"==typeof a&&a.length)for(c=0,d=a.length;d>c;c++)e=l(a[c]),e.el&&L(e.el,!0,b,e.id);else e=l(a),e.el&&L(e.el,!0,b,e.id);
    return f
    };
...
var ab=function(a,b,c,d){
    ...
    if(a)if("string"==typeof a){
        ...
        else if(a.length)for(var d=0,e=a.length;e>d;d++)c.push(l(a[d]).id);else c.push(l(a).id);
    return c
    },fb=function(a,b,c){
...
var gb=function(a,b){
    ...
    for(c=0,d=f.length;d>c;c++)e[f[c]]=cb(a,f[c],b);
    for(c=0,d=g.length;d>c;c++)e[g[c]]=db(a,g[c]);
    return e
    },jb=function(a){
    var b=ib(a,jb);
    return t.extend(b,{
...
this.select=function(a){
    ...
    for(var h in s){
        ...
        if(i||j||l)a:for(var n=0,o=s[h].length;o>n;n++){
            var p=s[h][n];
            if(fb(f,p.scope,!0)){
...
this.init=function(){
    ...
    if(!t.connectorsInitialized){
        for(var b=0;b<nb.length;b++)for(var c=0;c<ob.length;c++)a(ob[c],nb[b][1],nb[b][0]);
        t.connectorsInitialized=!0
        }
        p||(qb(),f.anchorManager=new t.AnchorManager({
        jsPlumbInstance:f
    }),f.setRenderMode(f.Defaults.RenderMode),p=!0,f.fire("ready",f))
...
if("string"==typeof d)g=c(arguments[0],{
    elementId:e,
    jsPlumbInstance:f
});
...
return g.id||(g.id="anchor_"+G()),g
    ...
    for(var e=[],g=0,h=b.length;h>g;g++)"string"==typeof b[g]?e.push(t.Anchors[b[g]]({
        elementId:c,
        jsPlumbInstance:d
...
this.makeTarget=function(c,d,e){
    ...
    for(var h=g.scope||f.Defaults.Scope,j=(!(g.deleteEndpointsOnDetach===!1),g.maxConnections||-1),k=g.onMaxConnections,m=function(c){
        ...
        var p=g._jsPlumb.EndpointDropHandler({
            ...
            isFull:function(a){
                var b=f.select({
                    target:e
                }).length,c=d.el._jsPlumbTarget,g=c.maxConnections>0&&b>=c.maxConnections;
                return g&&k&&k({
                    element:d.el,
                    connection:jpc
                },a),g
    ...
    n.scope=n.scope||h,n[q]=a.wrap(n[q],p),g.allowLoopback===!1&&(n.canDrop=function(a){
        ...
        }.bind(this),n=c.length&&c.constructor!=String?c:[c],o=0,p=n.length;p>o;o++)m(n[o]);
return this
    ...
    for(var h=g.maxConnections||1,i=g.onMaxConnections,j=function(c){
        ...
        if(3!==a.which&&2!==a.button){
            ...
            if(d=this.getId(this.getDOMElement(e)),c.enabled){
                ...
                if(c.maxConnections>=0&&c.uniqueEndpoint&&o>=c.maxConnections)return i&&i({
                    element:e,
                    maxConnections:h
                },a),!1;
...
}.bind(this),m=c.length&&c.constructor!=String?c:[c],o=0,p=m.length;p>o;o++)j(l(m[o]));
return this
    ...
    for(var a in this.sourceEndpointDefinitions)f.unmakeSource(a,!0);return this.sourceEndpointDefinitions={},this
    };
...
this.getScope=function(a){
    ...
    for(var a in this.targetEndpointDefinitions)f.unmakeTarget(a,!0);return this.targetEndpointDefinitions={},this
    };
    
var yb=function(b,c,d,e){
    var f="source"==b?this.sourceEndpointDefinitions:this.targetEndpointDefinitions;
    if(a.isString(c))f[c].enabled=e?!f[c].enabled:d;
    else if(c.length)for(var g=0,h=c.length;h>g;g++){
        var i=l(c[g]);
...
this.toggleSourceEnabled=function(a){
    ...
    if("object"==typeof a&&a.length)for(var d=0,e=a.length;e>d;d++)I(a[d],b,c);else I(a,b,c);
    return f
    ...
    var b,d=c();
    for(b in s)f.updateOffset({
        elId:b,
        recalc:!0,
        timestamp:d
    });for(b in s)I(b,null,d,a);return this
    },this.removeAllEndpoints=function(a,b){
    var c=function(a){
        var d,e,g=l(a),h=s[g.id];
        if(h)for(d=0,e=h.length;e>d;d++)f.deleteEndpoint(h[d]);
        if(delete s[g.id],b&&g.el&&3!=g.el.nodeType&&8!=g.el.nodeType)for(d=0,e=g.el.childNodes.length;e>d;d++)c(g.el.childNodes[d])
            };
...
this.clear=function(){
    ...
    for(var g=0,h=s[b].length;h>g;g++)s[b][g].setElementId(b),s[b][g].setReferenceElement(a);
...
jsPlumbUtil.extend(s,jsPlumbUtil.EventGenerator,{
    ...
    extend:function(a,b,c){
        var d;
        if(c)for(d=0;d<c.length;d++)a[c[d]]=b[c[d]];else for(d in b)a[d]=b[d];return a
        },
    floatingConnections:{},
...
jsPlumb.Endpoint=function(g){
    ...
    g.finaliseConnection,g.fireMoveEvent,this.idPrefix="_jsplumb_e_",this.defaultLabelLocation=[.5,.5],this.defaultOverlayKeys=["Overlays","EndpointOverlays"],OverlayCapableJsPlumbUIComponent.apply(this,arguments),this.getDefaultType=function(){
        return{
            parameters:{},
            scope:null,
...
j.isString(a)?this.endpoint=b(a,c):j.isArray(a)?(c=j.merge(a[1],c),this.endpoint=b(a[0],c)):this.endpoint=a.clone(),this.endpoint.clone=function(){
    ...
    var a=this.anchor.getCurrentLocation({
        element:this
    }),b=this.anchor.getOrientation(this),c=this.anchor.getCssClass(),d={
        bind:function(){},
        compute:function(){
            return[a[0],a[1]]
            },
...
this.initDraggable=function(){
    if(!q&&jsPlumb.isDragSupported(this.element)){
        var d={
            ...
            var a=!0;
            if(this.isEnabled()||(a=!1),null!=e||this.isSource||this.isTemporarySource||(a=!1),this.isSource&&this.isFull()&&!this.dragAllowedWhenFull&&(a=!1),null==e||e.isDetachable()||(a=!1),a===!1)return h.stopDrag&&h.stopDrag(this.canvas),o.stopDrag(),!1;
            for(var p=0;p<this.connections.length;p++)this.connections[p].setHover(!1);
            this.addClass("endpointDrag"),h.setConnectionBeingDragged(!0),e&&!this.isFull()&&this.isSource&&(e=null),h.updateOffset({
                elId:this.elementId
                }),m=this.makeInPlaceCopy(),m.referenceEndpoint=this,m.paint(),b(d,h);
            var q=i(m.canvas),r=jsPlumbAdapter.getOffset(q,this._jsPlumb.instance),s=i(this.canvas);
            if(jsPlumbAdapter.setPosition(d.element,r),this.parentAnchor&&(this.anchor=h.makeAnchor(this.parentAnchor,this.elementId,h)),h.setAttribute(this.canvas,"dragId",d.id),h.setAttribute(this.canvas,"elId",this.elementId),this._jsPlumb.floatingEndpoint=c(this.getPaintStyle(),this.anchor,this.endpoint,this.canvas,d.element,h,l,this.scope),this.canvas.style.visibility="hidden",null==e)this.anchor.locked=!0,this.setHover(!1,!1),e=k({
                sourceEndpoint:this,
                ...
                h.setDragScope(s,v),h.fire("connectionDrag",e),0===t?(n=[e.source,e.sourceId,s,u],e.source=d.element,e.sourceId=d.id):(n=[e.target,e.targetId,s,u],e.target=d.element,e.targetId=d.id),e.endpoints[0===t?1:0].anchor.locked=!0,e.suspendedEndpoint=e.endpoints[t],e.suspendedElement=e.endpoints[t].getElement(),e.suspendedElementId=e.endpoints[t].elementId,e.suspendedElementType=0===t?"source":"target",e.suspendedEndpoint.setHover(!1),this._jsPlumb.floatingEndpoint.referenceEndpoint=e.suspendedEndpoint,e.endpoints[t]=this._jsPlumb.floatingEndpoint,e.addClass(h.draggingClass),this._jsPlumb.floatingEndpoint.addClass(h.draggingClass)
                }
            ...
            if(h.setConnectionBeingDragged(!1),e&&null!=e.endpoints){
                ...
                if(e.endpoints[0===b?1:0].anchor.locked=!1,e.removeClass(h.draggingClass),this._jsPlumb&&(e.deleteConnectionNow||e.endpoints[b]==this._jsPlumb.floatingEndpoint)&&f&&e.suspendedEndpoint){
                    ...
                    h.setDragScope(n[2],n[3]),e.endpoints[b]=e.suspendedEndpoint,e.isReattach()||e._forceReattach||e._forceDetach||!e.endpoints[0===b?1:0].detach(e,!1,!1,!0,a)?(e.setHover(!1),e._forceDetach=null,e._forceReattach=null,this._jsPlumb.floatingEndpoint.detachFromConnection(e),e.suspendedEndpoint.addConnection(e),h.repaint(n[1])):h.deleteObject({
                        endpoint:c
                    })
                    }
                    h.remove(d.element,!1),h.deleteObject({
                    endpoint:m
                    ...
                    recalc:!1
                    })),h.fire("connectionDragStop",e,a),h.currentlyDragging=!1,e=null
                }
            }.bind(this);
...
computeAnchor:function(a){
    ...
    return function(b){
        ...
        if(null!=h){
            ...
            if(j)return h._forceReattach=!0,h.setHover(!1),void 0;
            ...
            if(g&&c.setDragScope(e,g),a.isFull(b)&&i.fire("maxConnections",{
                ...
                var m=function(){
                    ...
                    for(var b in a)h.setParameter(b,a[b]);if(h.suspendedEndpoint){
                        ...
                        }else a.draggable&&c.initDraggable(this.element,dragOptions,"internal",c);
...
prepareEndpoint:function(a,c,d,e,f,g,h,i){
    var j;
    if(e)d.endpoints[f]=e,e.addConnection(d);
    else{
    ...
    jsPlumb.AnchorManager=function(a){
        var b={},c={},d={},e={},f={
            ...
            DIAGONAL:"diagonal",
            IDENTITY:"identity"
        },g=["left","top","right","bottom"],h={},i=this,j={},k=a.jsPlumbInstance,l={},m=function(a,b,c,d,e,h){
            if(a===b)return{
        ...
        for(var m=0;m<g.length;m++)for(var n=0;n<g.length;n++)m!=n&&k.push({
            source:g[m],
            target:g[n],
    ...
    var d=k.getCachedData(a),f=d.s,g=d.o,h=function(b,d,f,g,h,i,j){
        if(g.length>0)for(var k=r(g,q[b]),l="right"===b||"top"===b,m=n(b,d,f,k,h,i,l),o=function(a,b){
            c[a.id]=[b[0],b[1],b[2],b[3]],e[a.id]=j
            },p=0;p<m.length;p++){
...
h("bottom",f,[g.left,g.top],b.bottom,!0,1,[0,1]),h("top",f,[g.left,g.top],b.top,!0,0,[0,-1]),h("left",f,[g.left,g.top],b.left,!1,0,[-1,0]),h("right",f,[g.left,g.top],b.right,!1,1,[1,0])
};
...
var u=function(b,c,d,e,f,g,h,i,j,k,l,m){
    var n,o=-1,p=-1,q=e.endpoints[h],r=q.id,s=[1,0][h],t=[[c,d],e,f,g,r],u=b[j],v=q._continuousAnchorEdge?b[q._continuousAnchorEdge]:null;
    if(v){
        var w=jsPlumbUtil.findWithFunction(v,function(a){
            return a[4]==r
            });
        if(-1!=w)for(v.splice(w,1),n=0;n<v.length;n++)jsPlumbUtil.addWithFunction(l,v[n][1],function(a){
        ...
        for(n=0;n<u.length;n++)1==a.idx&&u[n][3]===g&&-1==p&&(p=n),jsPlumbUtil.addWithFunction(l,u[n][1],function(a){
...
var v=function(a){
    ...
    for(var b=a.faces||["top","right","bottom","left"],f=!(a.clockwise===!1),g={},h={
        top:"bottom",
        right:"left",
        left:"right",
        bottom:"top"
        ...
        left:"bottom",
        bottom:"right"
    },k=f?i:j,l=f?j:i,m=a.cssClass||"",n=0;n<b.length;n++)g[b[n]]=!0;
...
d.prototype={
    ...
    var e=(a.direction||1)<0?-1:1,f=a.paintStyle||{
        lineWidth:1
    },g=a.foldback||.623;
...
jsPlumbUtil.extend(f,[jsPlumb.jsPlumbUIComponent,d],{
...
jsPlumb.registerConnectorType(c,"StateMachine")
    ...
    var a=function(a){
        ...
        this.type="Bezier",this.getCurviness=function(){
            ...
            var d=c.sourcePos,e=c.targetPos,f=Math.abs(d[0]-e[0]),g=Math.abs(d[1]-e[1]),h=d[0]<e[0]?f:0,i=d[1]<e[1]?g:0,j=d[0]<e[0]?0:f,k=d[1]<e[1]?0:g,l=this._findControlPoint([h,i],d,e,c.sourceEndpoint,c.targetEndpoint,a.so,a.to),m=this._findControlPoint([j,k],e,d,c.targetEndpoint,c.sourceEndpoint,a.so,a.to);
...
jsPlumbUtil.extend(a,jsPlumb.Connectors.AbstractConnector),jsPlumb.registerConnectorType(a,"Bezier")
    ...
    var w=function(a){
        ...
        this.svg=q("svg",e),a.useDivWrapper?(this.canvas=document.createElement("div"),this.canvas.style.position="absolute",jsPlumbUtil.sizeElement(this.canvas,0,0,1,1),this.canvas.className=d):(p(this.svg,{
            "class":d
...
var x=window.SvgEndpoint=function(a){
    ...
    b.renderer.paint=function(a){
        var b=jsPlumb.extend({},a);
        b.outlineColor&&(b.strokeWidth=b.outlineWidth,b.strokeStyle=jsPlumbUtil.convertStyle(b.outlineColor,!0)),null==this.node?(this.node=this.makeNode(b),this.svg.appendChild(this.node)):null!=this.updateNode&&this.updateNode(this.node),u(this.svg,this.node,b,[this.x,this.y,this.w,this.h],this),r(this.node,[this.x,this.y])
        }.bind(this)
    };
...
var y=function(a,b){
    a.apply(this,b),jsPlumb.jsPlumbUIComponent.apply(this,b),this.isAppendedAtTopLevel=!1,this.path=null,this.paint=function(a,d){
        if(a.component.svg&&d){
            null==this.path&&(this.path=q("path",{
                "pointer-events":"all"
    ...
    var f=1e3,g=function(a,b){
        ...
        jsPlumb.jsPlumbUIComponent.apply(this,arguments),this.opacityNodes={
            ...
            a.opacityNodes.stroke=h("stroke",[0,0,1,1],{
                opacity:"0.0"
            },b,a._jsPlumb.instance),a.opacityNodes.fill=h("fill",[0,0,1,1],{
                opacity:"0.0"
...
var n=jsPlumb.ConnectorRenderers.vml=function(b,c){
    ...
    this.paint=function(e){
        if(null!==e){
            ...
            for(var j=this.getSegments(),k={
                path:""
            },m=[this.x,this.y,this.w,this.h],n=0;n<j.length;n++)k.path+=jsPlumb.Segments.vml.SegmentRenderer.getPath(j[n]),k.path+=" ";
            if(e.outlineColor){
                ...
                for(var r in a)q[r]=e[r];null==this.bgCanvas?(k["class"]=d,k.coordsize=m[2]*f+","+m[3]*f,this.bgCanvas=h("shape",m,k,b.parent,this._jsPlumb.instance,!0),i(this.bgCanvas,m),this.appendDisplayElement(this.bgCanvas,!0),this.initOpacityNodes(this.bgCanvas,["stroke"]),this.bgCanvas._jsPlumb=c):(k.coordsize=m[2]*f+","+m[3]*f,i(this.bgCanvas,m),g(this.bgCanvas,k)),l(this.bgCanvas,q,this)
                }
...
var o=window.VmlEndpoint=function(a){
    m.apply(this,arguments),this._jsPlumb.vml=null,this.canvas=document.createElement("div"),this.canvas.style.position="absolute",this._jsPlumb.clazz=this._jsPlumb.instance.endpointClass+(a.cssClass?" "+a.cssClass:""),a._jsPlumb.appendElement(this.canvas,a.parent),this.paint=function(a,b){
        ...
        jsPlumbUtil.sizeElement(this.canvas,this.x,this.y,this.w,this.h),null==this._jsPlumb.vml?(c["class"]=this._jsPlumb.clazz,d=this._jsPlumb.vml=this.getVml([0,0,this.w,this.h],c,b,this.canvas,this._jsPlumb.instance),this.appendDisplayElement(d,!0),this.appendDisplayElement(this.canvas,!0),this.initOpacityNodes(d,["fill"])):(i(d,[0,0,this.w,this.h]),g(d,c)),l(d,a,this)
        }
    };
...
jsPlumb.extend(jsPlumbInstance.prototype,{
    ...
    getDOMElement:function(a){
        return null==a?null:(a="string"==typeof a?a:null!=a.length?a[0]:a,"string"==typeof a?document.getElementById(a):a)
        },
    ...
    doAnimate:function(a,c,d){
        ...
        var e=jsPlumbAdapter.getOffset(a,this),f=b(e,c),g=f[0]-e.left,h=f[1]-e.top,i=d.duration||250,j=15,k=i/j,l=j/i*g,m=j/i*h,n=0,o=setInterval(function(){
            jsPlumbAdapter.setPosition(a,{
                left:e.left+l*(n+1),
                top:e.top+m*(n+1)
                }),null!=d.step&&d.step(),n++,n>=k&&(window.clearInterval(o),null!=d.complete&&d.complete())
            },j)
        },
